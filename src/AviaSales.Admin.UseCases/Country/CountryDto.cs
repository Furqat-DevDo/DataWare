...
/// <param name="Cca3">The three-letter country code based on the ISO 3166-1 alpha-3 standard.</param>
/// <param name="Ccn3">The numeric country code based on the ISO 3166-1 numeric standard.</param>
public record CreateCountryDto(string Name, string Cioc, double? Area, string Capital, string Cca2, string Cca3, string Ccn3);
...
public record CountryFilters(string? Name, string? Capital, string? Code, Pager? Pager);